        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-sm text-slate-300">
              ...
              eğitim ve aile birleşimi vizelerinde uzman danışmanlık sunuyoruz.
            </p>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li>
                <Link href="/hakkimizda.php" className="hover:text-brand-coral">
                  Hakkımızda
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <Link href="/basvuru.php" className="hover:text-brand-coral">
                  Başvuru Formu
                </Link>
              </li>
              <li>
                <Link href="/cerezler.php" className="hover:text-brand-coral">
                  Çerez Politikası
                </Link>
              </li>
              <li>
